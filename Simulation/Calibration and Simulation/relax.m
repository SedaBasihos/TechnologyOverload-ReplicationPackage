...
% Trimborn, Koch, Steger (2008) Multidimensional Transitional Dynamics: A
...
%Storing of variables in x and creation of actual time t (I want transitional dynamics interpretable. So, 
%I am slowing down time by a factor of 10 so that being close to the (potential) real time profile of variables, 
%i.e., dilation of one epoch to 10 -- expansion of time will not change the charateristics of phase diagram)
x=zeros(N,M);
t=zeros(1,M);
tau=[0:1/(M-1):1];
for i=1:M
